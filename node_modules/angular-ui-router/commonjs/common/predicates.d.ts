...
export declare const isFunction: (x) => x is Function;
export declare const isNumber: (x) => x is number;
export declare const isString: (x: any) => x is string;
export declare const isObject: (x: any) => boolean;
export declare const isArray: (arg: any) => arg is any[];
export declare const isDate: (x) => x is Date;
export declare const isRegExp: (x) => x is RegExp;
/**
